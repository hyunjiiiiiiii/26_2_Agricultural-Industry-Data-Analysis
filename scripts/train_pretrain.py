...
def train_pretrain(config_path="config.yaml"):
    ...
    # 모델 초기화 (YOLOv11)
    # yolo11n.pt, yolo11s.pt, yolo11m.pt, yolo11l.pt, yolo11x.pt 중 선택
    model_size = model_config['model_size']
    if not model_size.startswith('yolo11'):
        model_size = f"yolo11{model_size}" if model_size in ['n', 's', 'm', 'l', 'x'] else 'yolo11n'
